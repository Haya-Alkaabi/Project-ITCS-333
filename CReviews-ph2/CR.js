document.addEventListener('DOMContentLoaded', () => {
    ...
    if (postCommentButton) {
        console.log('Post button element found.'); // ADD THIS LINE
        postCommentButton.addEventListener('click', () => {
            console.log('Post button was clicked!'); // ADD THIS LINE
        ...
        console.log('Post button element NOT found.'); // ADD THIS LINE
    }
    ...
    if (categoryFilter) {
        categoryFilter.addEventListener('change', () => {
            applyFiltersAndSort();
            // We don't reset the sortByFilter here if we want the sort to be independent
        });
    }
